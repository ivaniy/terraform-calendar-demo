...
// HookSecretConfig hookSecretConfig = new HookSecretConfig('GitHubSecret')
// GitHubServerConfig gitHubServerConfig = new GitHubServerConfig('GitHubSecret')
// gitHubServerConfig.setManageHooks(false) 
// gitHubServerConfig.setApiUrl("https://github.com")

// def global_settings = Jenkins.instance.getExtensionList(GitHubPluginConfig.class)[0]

// if (!global_settings) {
//   global_settings.setConfigs([gitHubServerConfig])
//   global_settings.setHookSecretConfig(hookSecretConfig)
// } else {
  
// }

// println (global_settings.getClass())
...
github_plugin = [
    ...
    //hookSharedSecretId: 'GitHubSecret',
    servers: [
        'GitHub.com': [
            apiUrl: 'https://api.github.com',
            manageHooks: false,
            credentialsId: 'GitHubSecret',
        ]
    ]
]
